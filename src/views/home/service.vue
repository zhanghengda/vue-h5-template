<template>
  <div class="page page-current">
    <van-nav-bar title="Terms of Service" left-arrow @click-left="onClickLeft" />
    <div class="content">
      <h2 class="title">Terms of Service</h2>
      <p>
        Please read these Terms of Service (the “Agreement”) carefully. By accepting these “Terms of Service, you
      ...
      <p>BY USING THE SITE, YOU ACCEPT THESE TERMS OF SERVICE AND AFFIRM THAT YOU ARE OLDER THAN 13 YEARS.</p>
      <p>References to “you” and “your” in this Agreement will refer to both the individual using the Site.</p>
      <p>
        THIS AGREEMENT CONTAINS A MANDATORY ARBITRATION PROVISION THAT, AS FURTHER SET FORTH IN SECTION 18 BELOW,
        REQUIRES THE USE OF ARBITRATION ON AN INDIVIDUAL BASIS TO RESOLVE DISPUTES, RATHER THAN JURY TRIALS OR ANY OTHER
        COURT PROCEEDINGS, OR CLASS ACTIONS OF ANY KIND.
      </p>

      <p class="title2">. Changes</p>

      <p>
        We may change this Agreement from time to time by notifying you of such changes by any reasonable means,
        including by posting a revised Agreement through the Site. Any such changes will not apply to any dispute
        between you and us arising prior to the date on which we posted the revised Agreement incorporating such
        changes, or otherwise notified you of such changes.
      </p>
      <p>
        You agree that your continued use of the Site following any changes to this Agreement will constitute an
        irrefutable presumption of your acceptance of such changes. The “Last Updated” legend above indicates when this
        Agreement was last changed. We may, at any time and without liability, modify or discontinue all or part of the
        Site (including access to the Site via any third-party links); charge, modify or waive any fees (which shall
        remain free for the foreseeable future) required to use the Site; or offer opportunities to some or all Site
        users.
      </p>
      ...
      <p>
        The Site is controlled or operated (or both) from the European Economic Area, and is not intended to subject us
        to any jurisdiction or law outside this area. The Site may not be appropriate or available for use in some
        jurisdictions. Any use of the Site is at your own risk, and you must comply with all applicable laws, rules and
        regulations in doing so. We may limit the Site’s availability at any time, in whole or in part, to any person,
        geographic area or jurisdiction that we choose.
      </p>

      <p class="title2">4. Rules of Conduct</p>

      <p>In connection with the Site, you must not:</p>
      <p>
        Post, transmit or otherwise make available through or in connection with the Site any materials that are or may
        be: (a) threatening, harassing, degrading, hateful or intimidating, or otherwise fail to respect the rights and
        dignity of others; (b) defamatory, libelous, fraudulent or otherwise tortious; (c) obscene, indecent,
      ...
      <p>
        ...
        or otherwise exploit any portion of (or any use of) the Site except as expressly authorized herein, without our
        express prior written consent.
      </p>
      <p>
        Reverse engineer, decompile or disassemble any portion of the Site, except where such restriction is expressly
        prohibited by applicable law.
      </p>
      <p>Remove any copyright, trademark or other proprietary rights notice from the Site.</p>
      <p>
        Frame or mirror any portion of the Site, or otherwise incorporate any portion of the Site into any product or
        service, without our express prior written consent.
      </p>
      ...
      <p>
        ...
        presentation of the Site, without our express prior written consent. You are responsible for obtaining,
        maintaining and paying for all hardware and all telecommunications and other services needed to use the Site.
      </p>
      ...
      <p>Reproduce, modify, adapt, translate, create derivative works of any iframed portion of the Site</p>
      <p>
        Remove, hide or in any other way hinder the viewability of any copyright, trademark or other proprietary rights
        notice from the iframed portion of the Site.
      </p>
      <p>Remove, block, hide or in any other way hinder the performance of links in the iframed portion of the Site.</p>
      <p>
        Remove, block, make invisible or in any other way hinder the operation of advertising included in the iframed
        portion of the Site.
      </p>
      ...
      <p>
        The Site may make available listings, descriptions and images of goods or services or related coupons or
        discounts (collectively, “Products”), as well as references and links to Products. Such Products may be made
        available by us or by third parties, and may be made available for any purpose, including general information
        purposes. The availability through the Site of any listing, description or image of a Product does not imply our
        endorsement of such Product or affiliation with the provider of such Product. We make no representations as to
        the completeness, accuracy, reliability, validity or timeliness of such listings, descriptions or images
        (including any features, specifications and prices contained therein). Such information and the availability of
        any Products (including the validity of any coupon or discount) is subject to change at any time without notice.
        It is your responsibility to ascertain and obey all applicable local, state, federal and foreign laws (including
        minimum age requirements) regarding the possession, use and sale of any Product.
      </p>

      <p class="title2">7. Profiles and Forums.</p>
      ...
      <p>
        ...
        sub-licensable (through multiple tiers) license, without additional consideration to you or any third party, to
        reproduce, distribute, perform and display (publicly or otherwise), create derivative works of, adapt, modify
        and otherwise use, analyze and exploit such Submission, in any format or media now known or hereafter developed,
        and for any purpose (including promotional purposes, such as testimonials).
      </p>
      <p>
      ...
      <p>
        ...
        accurate, and are not fraudulent, tortious or otherwise in violation of any applicable law or any right of any
        third party. To the extent permitted by applicable law, you further irrevocably waive any “moral rights” or
        other rights with respect to attribution of authorship or integrity of materials regarding each Submission that
        you may have under any applicable law under any legal theory.
      </p>

      <p class="title2">9. Monitoring</p>
      ...
      <p>
        ...
        without prejudice to the Privacy Policy.
      </p>

      <p class="title2">10. Your Limited Rights</p>
      <p>
        Subject to your compliance with this Agreement, and solely for so long as you are permitted by us for you to use
        the Site, you may view any portion of the Site to which we provide you access under this Agreement solely for
      ...
      <p>
        ...
        construed as granting any right to use any trade names, trademarks, service marks or logos without the express
        prior written consent of the owner.
      </p>

      <p class="title2">12. Third Party Materials; Links</p>

      <p>
        Certain Site functionality may make available access to information, products, services and other materials
        (including, without limitation, advertisements and promotional material) made available by third parties
        (including, without limitation, through techniques such as iFrames), including Submissions (“Third Party
        Materials”), or allow for the routing or transmission of such Third Party Materials, including via links. By
        using such functionality, you are directing us to access, route and transmit to you the applicable Third Party
        Materials.
      </p>
      <p>
      ...
      <p>
        YOUR USE OF THIRD PARTY MATERIALS IS AT YOUR OWN RISK AND IS SUBJECT TO ANY ADDITIONAL TERMS, CONDITIONS AND
        POLICIES APPLICABLE TO SUCH THIRD PARTY MATERIALS (SUCH AS TERMS OF SERVICE OR PRIVACY POLICIES OF THE PROVIDERS
        OF SUCH THIRD PARTY MATERIALS).
      </p>

      <p class="title2">13. Promotions</p>

      <p>
        Any sweepstakes, contests, raffles, surveys, games or similar promotions (collectively, “Promotions”) made
        available through the Site may be governed by rules that are separate from this Agreement. If you participate in
        any Promotions, please review the applicable rules as well as our Privacy Policy. If the rules for a Promotion
        conflict with this Agreement, the Promotion rules will govern.
      </p>

      <p class="title2">14. Disclaimer Of Warranties</p>
      ...
      <p>
        ...
        OF ANY SUBMISSIONS (B) WITHOUT LIMITING THE FOREGOING, WE SHALL NOT BE LIABLE FOR DAMAGES OF ANY KIND RESULTING
        FROM YOUR USE OF OR INABILITY TO USE THE SITE OR FROM ANY PRODUCTS OR THIRD PARTY MATERIALS, INCLUDING FROM ANY
        VIRUS THAT MAY BE TRANSMITTED IN CONNECTION THEREWITH; (C) YOUR SOLE AND EXCLUSIVE REMEDY FOR DISSATISFACTION
        WITH THE SITE OR ANY PRODUCTS OR THIRD PARTY MATERIALS IS TO STOP USING THE SITE; AND (D) OUR MAXIMUM AGGREGATE
        LIABILITY OF FOR ALL DAMAGES, LOSSES AND CAUSES OF ACTION, WHETHER IN CONTRACT, TORT (INCLUDING NEGLIGENCE) OR
        OTHERWISE, SHALL BE THE GREATER OF THE TOTAL AMOUNT, IF ANY, PAID BY YOU TO US TO USE THE SITE BUT NO MORE THAN
        100 EUR CONSIDERING USE OF THE SITE IS FREE OF CHARGE. ALL LIMITATIONS OF LIABILITY OF ANY KIND (INCLUDING IN
        THIS SECTION AND ELSEWHERE IN THIS AGREEMENT) ARE MADE FOR THE BENEFIT OF BOTH US AND THE AFFILIATED ENTITIES,
        AND THEIR RESPECTIVE SUCCESSORS AND ASSIGNS.
      </p>

      <p class="title2">16. Indemnity</p>

      <p>
        To the fullest extent permitted under applicable law, you agree to defend, indemnify and hold us and the
        Affiliated Entities harmless including their respective successors and assigns, from and against all claims,
        liabilities, damages, judgments, awards, losses, costs, expenses and fees (including attorneys’ fees) arising
        out of or relating to (a) your use of, or activities in connection with, the Site (including all Submissions);
        and (b) any violation or alleged violation of this Agreement by you.
      </p>

      <p class="title2">17. Termination</p>
      ...
      <p class="title2">18. Governing Law; Arbitration</p>
      ...
      <p>
        If you believe in good faith that materials available on the Site infringe your copyright, you (or your agent)
      ...
      <p class="title2">22. Miscellaneous</p>
