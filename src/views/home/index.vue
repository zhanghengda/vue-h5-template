...
<template>
  <div class="page-group">
    ...
    <div class="page page-current" id="xindex">
      <!-- 标题 -->
      <header
        class="bar bar-nav tit"
        id="shopImg"
      >
      <img alt="" src="https://trace.cciccloud.com/trace-backend/images/2021-11-17/910612857824215040.jpg"></img>
      </header>
      <!-- 页尾 -->
      <nav class="bar bar-tab">
        <p class="buttons-row endpage">
          <a
            href="complaints.html?serial_num=1102347000035519268168064&amp;product_pk=845310746102333440"
          ...
          <a
            ...
            id="infosearch"
            href="authen.html?serial_num=1102347000035519268168064"
            ><span class="endpage-span-search">防伪查询</span></a
          >
        </p>
      </nav>

      <div class="content contentDivOne native-scroll">
        <!-- 图片幻灯片 -->
        <!-- Slider -->
        <div class="indexBanner">
          <div id="slide" style="overflow: hidden">
            <div class="slidesjs-container" style="overflow: hidden; position: relative; width: 414px; height: 246.1px">
              <div class="slidesjs-control" style="position: relative; left: 0px; width: 414px; height: 246.1px">
                <div
                  class="page slidesjs-slide"
                  slidesjs-index="0"
                  style="
                    position: absolute;
                    top: 0px;
                ...
                >
                  <a href=""
                    ><img
                      src="https://trace.cciccloud.com/trace-backend/images/2021-05/845310746869891072.JPG"
                      style="height: 100%"
                  /></a>
                </div>
                <div
                ...
                >
                  <a href=""
                    ><img
                      src="https://trace.cciccloud.com/trace-backend/images/2021-05/845310751932416000.JPG"
                      style="height: 100%"
                  /></a>
                </div>
                <div
                ...
                >
                  <a href=""
                    ><img
                      src="https://trace.cciccloud.com/trace-backend/images/2021-05/845310752750305280.JPG"
                      style="height: 100%"
                  /></a>
                </div>
              </div>
            </div>
            <ul class="slidesjs-pagination" style="margin-left: -29.5px">
              <li class="slidesjs-pagination-item"><a href="#" data-slidesjs-item="0" class="">1</a></li>
              <li class="slidesjs-pagination-item"><a href="#" data-slidesjs-item="1" class="active">2</a></li>
        ...
        <div class="baccol">
          <div class="baccol-div">
            <div class="baccol-cdiv">
              <!-- <span class="productname baccol-span"></span> -->
            ...
            <div>
              <!-- <span class="companyNameImg baccol-span1"></span> -->
        ...
        <!-- 标签页 -->
        <div class="buttons-tab fixed-tab" data-offset="65">
          <a href="#tab1" class="tab-link active button tabstyle">产品信息</a>
          <a href="#tab2" class="tab-link button tabstyle" id="companyid">企业信息</a>
          <a href="#tab3" class="tab-link button tabstyle" id="origin">追溯信息</a>
        </div>
              ...
              <div class="list-block liststyle">
                <ul class="productdata">
                  ...
                  <!--                       <li  class="producttype" >
                          <div class="item-content indexItemContent">
                              <div class="liststyle-div2">
                                  <div class="item-title label indexItemTitle">产品类别 :&nbsp;</div>
                                  <div class="item-input indexItemInput">
                                      <p class="productType liststyle"></p>
                                  </div>
                              </div>
                          </div>
                      </li>
 -->
              ...
              <div class="richTextContent" id="richtext" >
                <p
                >
                 <span>委托单位：</span>
                 <span>琦谜奢宝</span>
                ...
                <p>
                  <span >
                      <span style="font-family: sans-serif">检验日期：</span>
                      2021.05.21</span>
                  </p>
                <p >
                     <span>检验结论：</span>
                 <span>送检样品符合品牌/制造商公示的技术信息和工艺特征。</span>
                </p>
                <p>
                  
                <span style="font-family: sans-serif">备注：</span>
                <span style="font-family: sans-serif">1、检验结果仅对送检样品负责，若标签损毁、标签涂改，显示内容无效。</span>
                 
                </p>
                <p  >

                <span style="font-family: sans-serif">2、若对显示的内容和结论持有异议，需在检验日期后15日内提出，逾期不予受理。</span>
                 
                </p>
                <p >
                    <span style="font-family: sans-serif">3、客户信息及样品均由委托单位提供，检验结果不涉及样品品质检测等信息。</span>
                </p>
              </div>
            </div>
            <div id="tab2" class="tab">
              ...
              <div class="tab2-div2">
                <img class="tab2-img" id="logo" src="" onclick="showImg(this)" />
                <span class="companyname tab2-span"></span>
                <div class="hb-box">
                ...
                <span class="businessElectronicFile tab2-span2"> </span>
                <div class="bot"></div>
              </div>
              <div class="tab2-div3">
                <span class="tab2-span3"> 资质信息</span>
              </div>
              <div class="tab2-div4" id="imgcontend" style="text-align: center"></div>
            </div>
            <!-- 流程列表 -->
            <div id="tab3" class="tab autoheigth">
              <ul class="tab3-ul" id="ullist"></ul>
            </div>
          </div>
        </div>
      </div>
